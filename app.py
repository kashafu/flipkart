...
def get_product_info(temp_product_page, search, product_link):
    ...
    try:
        image_container = temp_product_page.find_all('div', {'class': '_1AtVbE'})[0]
        product_image_url = image_container.find('img')['src']
    except:
        product_image_url = 'No image available for ' + search
        ...
        try:
            ...
            try:
                db_connetion = mg.MongoClient(
                    "mongodb+srv://test:test@cluster0.yi3ke5e.mongodb.net/?retryWrites=true&w=majority")
            ...
            try:
                ...
                if (check.count() > 0):
                    ...
                    try:
                        ...
                        if (len(reviews) < 21 and total_reviews > 10):
                        ...
                        elif (len(reviews) < 21 and total_reviews < 10):
